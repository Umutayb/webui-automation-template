Here is the modified `README.md` focused exclusively on **Web UI** and **API** testing, removing all references to Mobile and Desktop automation while keeping the dual-design steps intact.

---

```markdown
# 🥒 Web & API Automation Template

A unified test automation framework built on **Java** and **Cucumber**. This framework utilizes the power of the **Pickleib** library to support **Web UI** and **API** testing within a single codebase.
...
* **Platform Support:**
    * **Web:** Selenium WebDriver (Chrome, Firefox, Edge, Safari).
    * **API:** `wasapi` & RestAssured integration.
...
public class CommonSteps extends PageJsonDesign {
    ...
    public CommonSteps() {
        super(
                ...
                Hooks.initialiseAppiumDriver, // Passed as false/null for Web-only runs
